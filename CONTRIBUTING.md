# Contributing to Stacks · EcommerceOperator
...
```bash
git clone https://github.com/smcatl/EcommerceOperator.git
cd ecommerceoperator
npm install
...
- `main` → production (auto-deploys to https://ecommerceoperator.vercel.app)
...
Push to `main` → Vercel auto-deploys to https://ecommerceoperator.vercel.app.

## Where to ask for help

- **Linear:** [Stacks · EcommerceOperator](https://linear.app/skyyield/project/stacks-ecommerceoperator-727d3f00ef9c) — file an issue or comment on existing
